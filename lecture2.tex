...
% frame slide
\title{\coursename}
\subtitle{Lecture 2: Monte Carlo, Vectors, and}
...
\lstinputlisting{code/lecture2-random.cpp}
...
\lstinputlisting{code/lecture2-distrandom.cpp}
...
\lstinputlisting{code/lecture2-average.cpp}
...
\lstinputlisting[firstline=7, lastline=13]{code/lecture2-average.cpp}
\end{block}
...
\lstinputlisting{code/lecture2-averageContainers.cpp}
...
\lstinputlisting{code/lecture2-median.cpp}
