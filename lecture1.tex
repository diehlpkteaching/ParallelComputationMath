...
\lstinputlisting{chapter2/lecture1-1.cpp}

\begin{block}{Compile}
\lstinputlisting[language=bash,firstline=2, lastline=2]{chapter2/lecture1-1.sh}
\end{block}


\begin{block}{Run}
\lstinputlisting[language=bash,firstline=3, lastline=3]{chapter2/lecture1-1.sh}
\end{block}
...
\only<1>{
\lstinputlisting{chapter2/lecture1-2.cpp}
}
\only<2>{
\lstinputlisting[firstline=3, lastline=3]{chapter2/lecture1-2.cpp}
\lstinputlisting[firstline=9, lastline=9]{chapter2/lecture1-2.cpp}
...
\only<3>{
\lstinputlisting[firstline=10, lastline=10]{chapter2/lecture1-2.cpp}
...
\lstinputlisting[firstline=12, lastline=12]{chapter2/lecture1-3.cpp}
